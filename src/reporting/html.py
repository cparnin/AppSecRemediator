...
def generate_html_report(findings: List[Dict[str, Any]], ai_summary: str, output_dir: str, repo_path: Optional[str] = None) -> str:
    """
    ...
    try:
        ...
        # Add timestamp for when report was generated
